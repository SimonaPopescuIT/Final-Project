  ...
  return (
    <>
      ...
      <div className='container'>
        <div className='text3'>
          <h2 className='title'>Scapă de Celulită cu Masajul Anticelulitic!</h2>
          ...
          <p>1. Reducerea Celulitei:
            Masajul anticelulitic ajută la descompunerea grăsimilor subcutanate și la uniformizarea aspectului pielii, reducând vizibilitatea celulitei.

            2. Îmbunătățirea Aspectului Pielii:
            Această tehnică stimulează producția de colagen și elastină, esențiale pentru o piele tonifiată și elastică. Pielea dumneavoastră va deveni mai fermă și mai netedă.<br />
